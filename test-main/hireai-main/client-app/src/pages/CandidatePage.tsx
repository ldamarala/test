...
import JobApplicationsearch from '../../src/component/job/JobApplicationSearch'
...
export default function CandidatePage() {
 ...
 const [searchApplicationkeywords,setSearchApplicationkeywords]=useState({
    searchkeyword:'',
    location:'',
    });
 ...
 const searchapplicationdata = (keywords) =>{
    setSearchApplicationkeywords(keywords)
 }
 ...
 <MyJobApplications filterdata={searchApplicationkeywords}/>
 </CustomTabPanel>
