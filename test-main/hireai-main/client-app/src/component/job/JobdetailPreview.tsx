            ...
            <Stack sx={{ ...style, pt: 15, pb: 2, mt: 10 }}>
               <Container id="job-details" sx={{ py: { xs: 8, sm: 16 } }}>
                  ...
                  <Grid container spacing={2}>
                     <Grid item xs={16} style={{maxWidth:800}} >
                        {/* <Divider /> */}
                        <Grid
                           container
                           item
                     ...
                     <Grid
                        item
                        xs={3}
                        sx={{ display: { xs: 'none', sm: 'flex' }, maxwidth: 200 }}>
                        <Card
                           variant="outlined"
                           sx={{
                              height: '100%',
                           ...
                           <Stack sx={{ width: '100%', textAlign: 'left' }}>
                              ...
                              <Typography
                                 ...
                                 sx={{ my: 0.5, pt: 2 }}>
                                 Published on:{' '}
                                 <span style={{ fontSize: 15, fontWeight: 400, paddingLeft: 5 }}>{new Date(jobDetails?.time_created).toDateString()}</span>
                              </Typography>
                              <Typography
                                 color="text.secondary"
                                 variant="h6"
                                 align="left"
                                 sx={{ my: 0.5 }}>
                                 Open positions:<span style={{ fontSize: 15, fontWeight: 400, paddingLeft: 5 }}> {jobDetails?.open_positions}</span>
                              </Typography>
                              <Typography
                                 color="text.secondary"
                                 variant="h6"
                                 align="left"
                                 sx={{ my: 0.5 }}>
                                 Salary:<span style={{ fontSize: 1, fontWeight: 440, paddingLeft: 5 }}>{jobDetails?.salary}</span>
                              </Typography>
                              <Typography
                                 color="text.secondary"
                                 variant="h6"
                                 align="left"
                                 sx={{ my: 0.5 }}>
                                 Job Nature:<span style={{ fontSize: 15, fontWeight: 400, paddingLeft: 5 }}>{jobDetails?.job_nature}</span>
                              </Typography>
                           </Stack>
                        </Card>
                     </Grid> 
