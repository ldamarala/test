                    ...
                    <Table size="small" sx={{ marginBottom: 2 }}>
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="center" style={{ 'width': '150px' }}>Link Sent</TableCell>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell align='center'>
                            <ResumeFeedbackModal aiInterview={aiInterview}
...
function JobApplicationDetailsModal(props: {
  ...
  let points = []; // Initialize points outside of the conditional check

  if (jobApplication && jobApplication.resume_feedback) {
    const feedback = jobApplication.resume_feedback;
    points = feedback.split('.').map(point => point.trim()).filter(point => point !== '');
  }
        ...
        <Stack sx={{ ...style, pt: 15, pb: 2 }}>
          ...
          <TableContainer
            ...
            <Table stickyHeader aria-label="collapsible table">
              <TableHead>
                <TableRow>
                  <TableCell align="center" style={{ width: 150 }}>Resume Rating</TableCell>
              ...
              <TableBody >
                <TableRow sx={{ '& > *': {borderBottom: 'unset'}, }}>
                  ...
                  <TableCell align={jobApplication.resume_feedback ? 'inherit' : 'center'}>
                  <div  style={{ maxHeight: '200px' , margin: '0', overflow:jobApplication.resume_feedback ? 'auto' : 'hidden', overflowY:jobApplication.resume_feedback?'scroll':'hidden'}}>
                    {jobApplication?.resume_feedback ? (
